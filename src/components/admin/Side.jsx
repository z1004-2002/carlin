...
import { FaBook, FaBookOpen, FaUserEdit } from "react-icons/fa";
...
const SideBarData = [
  {
    title: "Utilisateurs",
    subCategory: [
      { icon: <FaUserEdit />, name: "Ajouter un Utilisateur", to: "/admin/dashboard" },
    ],
  }
];

const Side = ({ dimension, status }) => {
  ...
  return (
    <div
      ...
      className="side w-[20%] z-20 sm:w-[80%] ease-in-out duration-500 fixed top-0 left-0 bottom-0 pt-20 sm:-translate-x-[100%]"
    >
